...
SBFZ, SBRJ e SBGL, respectivamente. Países com muitos aeroportos, como os EUA, possuem como prefixo a letra K, 
logo as três letras ficam livres, podendo assim ter mais códigos para uso.
...
Por exemplo, se o item "27008G16KT" é encontrado pela expressão 
\begin{verbatim}
...
algorítmo será uma lista de tuplas que serão enviadas para o front-end.
