...
Note que as tabelas "CommunicationType", "ILSCategory" e "PavementType" poderiam 
...
\begin{longtable}{|p{3cm}|p{6.6cm}|p{3cm}|}
    ...
    \endlastfoot
        ...
        recém-criados não aparecam enquanto outras informações ainda não foram cadastradas.
        & Boolean
        \\ \hline
\end{longtable}
...
As duas tabelas a seguir lista as diferentes categorias de Sistema de Pouso por 
