...
\abstractuk{%
It is an open source web application to auxiliate the flight simulator's users that don't have
...
(tower, ground, ATIS etc) and navigation frequencies (ILS, VOR etc) are shown. Also provided are the current 
...
Meus amigos do curso que me deram sugestões sobre a implementação: Daniel Guimarães 
